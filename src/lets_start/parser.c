...
/*   Updated: 2023/12/12 18:02:26 by mmanssou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
Die Funktion handle_syntax_error_p wird verwendet,
	um einen Syntaxfehler zu behandeln
und eine Fehlermeldung auszugeben. Sie nimmt den Index des
fehlerhaften Tokens und ein Array von Tokens als Parameter.
Die Funktion überprüft,
	ob das Token nach dem fehlerhaften Token NULL ist. Wenn ja,
	wird "newline" als
Fehlermeldung verwendet,
	sonst wird das nächste Token als Fehlermeldung verwendet.
*/
...
/*
1.Nimmt ein Array von Zeichenkettenpointern (tokens) und einen
Index (i) als Parameter.
