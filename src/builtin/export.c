...
Überprüft, ob die Zeichenkette new_var ein Gleichheitszeichen '=' enthält und ob die Variable bereits in der Umgebungsvariablenliste vorhanden ist.
Wenn new_var kein Gleichheitszeichen enthält und die Variable nicht in der Liste vorhanden ist, wird ein neuer Umgebungsvariablenknoten erstellt und der Liste hinzugefügt.
Andernfalls wird new_var in Schlüssel und Wert aufgeteilt und überprüft, ob der Schlüssel bereits in der Liste vorhanden ist.
Wenn der Schlüssel nicht vorhanden ist, wird ein neuer Umgebungsvariablenknoten erstellt und der Liste hinzugefügt.
