...
/*   Updated: 2023/12/12 18:17:36 by mmanssou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../../includes/minishell.h"

static int	zahle_nicht_umleitungs_tokens(char **tokens)
{
	int	i;
	int	j;
...
Sie berechnet die Anzahl der zu behaltenden Tokens, erstellt ein
neues Array ohne Umleitungen,
gibt das alte Array frei und weist das neue Array den Argumenten
des Befehls zu.
*/
static void	losche_red(char ***command_args)
{
	...
	nicht_umleitungs_tokens = zahle_nicht_umleitungs_tokens(*command_args);
